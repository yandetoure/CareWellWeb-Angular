...
import Swal from 'sweetalert2';import { AccountantSidebarComponent } from '../../sidebar/accountant-sidebar/accountant-sidebar.component'; 

@Component({
  selector: 'app-accountant-articles',
  standalone: true,
  imports: [ AccountantSidebarComponent,CommonModule, FormsModule, HttpClientModule, ],  
  templateUrl: './accountant-articles.component.html',
  styleUrl: './accountant-articles.component.css'
})
export class AccountantArticlesComponent {
